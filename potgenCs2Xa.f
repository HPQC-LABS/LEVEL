...
c***********************************************************************
     ...
     1                                                        NCN,CNN)
c-----------------------------------------------------------------------
c         **********    Version of  27 November 2012    **********
c      Potentials fitted to synthetic Hutson data from October 4
c
...
c  or at line 76     as ISTATE=2 for the a(^3\Sigma_u^+}) state.
c==============
c*** On INPUT:
c==============
...
c*** ISTATE =1 for X(^1\Sigma_g^+),  =2 for a(^3\Sigma_u^+) Cs2,
      DATA PPARA/5,5/, QPARA/5,5/,MMLRA/6,8,10,0, 6,8,10,0/,
     1  NLRA/20,5/, NU1A/-1,-1/, NT1A/ -1,-1/ 
      DATA DSCMA/3650.02865394d0, 2.787985972786D+02/,
     1  REQA/4.647956678750D+00,6.195930236666D+00/,
     2  RrefA/6.2d0,8.700d0/,
c** specify  up to 4 C_m long-range coefficients for up to 2 states
     4  CMMA/3.336564895634D+07,1.38d09,6.01d10,0.d0,3.336564895634D+07,
     5  1.38d9,6.01d10,0.d0/,
c** now specify up to 25 exponent parameters \beta_i for 2 states 
     6 PARMA/9.514711828134D-02,-3.692014052033D-01,-3.740415315198D-02,
     7  1.335781707798D-01,1.693540653982D-01,1.823042712714D-01,
     8  -7.479347252247D-02,3.824443932516D-01,3.023551088536D+00,
     9  -7.197371720968D-01,-1.584938235140D+01,3.411458496170D+00,
     a  5.406568459815D+01,-5.952316740314D+00,-1.094025085956D+02,
     b  5.110151287041D+00,1.311345230651D+02,-7.041218527575D-02,
     c -8.462274972340D+01,-1.550521257978D+00,2.247533335118D+01,
     d  4*0.d0, -4.623622457380D-01,-9.105524342901D-02,
     e  4.664356700125D-02,2.063210671444D-01,8.832318625103D-02,
     f  -5.944457061021D-01,19*0.d0/
